...
import { User, Globe, Moon, Sun, MessageSquare, LogOut, ChevronRight, ArrowLeft, Settings, Tractor, Flower, Info } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in">
      ...
      <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-3xl border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <button onClick={onOpenFeedback} className="w-full flex items-center justify-between p-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors border-b border-gray-100 dark:border-gray-700/50">
            <div className="flex items-center gap-4">
        ...
        <button onClick={onOpenAbout} className="w-full flex items-center justify-between p-5 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
            <div className="flex items-center gap-4">
                <div className="p-2.5 bg-teal-50 dark:bg-teal-900/20 rounded-xl text-teal-600 dark:text-teal-400">
                    <Info className="w-5 h-5" />
                </div>
                <div className="text-left">
                    <span className="block font-semibold text-gray-800 dark:text-gray-200">About Trishna</span>
                    <span className="text-xs text-gray-500 dark:text-gray-400">App info & features</span>
                </div>
            </div>
            <ChevronRight className="w-5 h-5 text-gray-400" />
        </button>
      ...
      <p className="text-center text-xs text-gray-400 pt-2">
         Trishna v1.0.0 • Made with 💚 for Farmers
      </p>
    </div>
  );
};
