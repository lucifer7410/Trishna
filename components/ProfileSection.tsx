...
const ProfileSection: React.FC<ProfileSectionProps> = ({ profile, onSave, onLogout }) => {
  ...
  return (
    <div className="space-y-6 pb-20 animate-fade-in relative">
      ...
      {/* Main Profile Card */}
      <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-3xl shadow-xl border border-white/50 dark:border-gray-700 p-6 relative overflow-hidden animate-fade-in-up">
